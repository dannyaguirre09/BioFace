...
class ChartConteoIngresoComponent extends React.Component {

    obtenerDatosContador = async () => {
        const uri = "https://localhost:44393/api/ReporteGeneral/?entrada=1"
        await fetch(uri)
            .then(res => res.json())
            .then(response => {
...
export default withRouter(ChartConteoIngresoComponent)