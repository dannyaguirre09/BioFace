...
class LineTop10PromedioSalida extends React.Component {

    obtenerDatosContador = async () => {
        const uri = "https://localhost:44393/api/ReporteGeneral/?mejorPromedioSalidas=0";
        await fetch(uri)
            .then(res => res.json())
            .then(response => {
    ...
    render() {
        return (
            <div>
                ...
                <h4 className="text-center">Top 10 personas peor promedio de hora de salida </h4>
...
export default withRouter(LineTop10PromedioSalida)