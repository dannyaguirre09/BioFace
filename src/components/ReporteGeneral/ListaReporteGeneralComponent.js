...
class ListaReportegeneralComponent extends React.Component {
    ...
    exportarExcel = (e) => {
        try {
            if (this.state.listaRegistros.length > 0) {
                ...
                FileSaver.saveAs(data, 'Reporte_Registros'  + fileExtension);
            } else {
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-md-5">
                                <div className="col-md-5">
                                    <div className="row">
                                        <Link to={'/reporte_general/dashboard'} style={{ backgroundColor: '#044F67' }} className="btn btn-block">Regresar</Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-5">
...
export default withRouter(ListaReportegeneralComponent)